...
class Property
{
    ...
    #[Assert\Range(
        min: 1,
        max: 40,
        notInRangeMessage: 'You must be between {{ min }}m² and {{ max }}m² rooms to enter',
    )]
    ...
    #[Assert\Range(
        min: 1,
        max: 40,
        notInRangeMessage: 'You must be between {{ min }}m² and {{ max }}m² bedrooms to enter',
    )]
    ...
    #[Assert\Range(
        min: 1,
        max: 40,
        notInRangeMessage: 'You must be between {{ min }}m² and {{ max }}m² floor to enter',
    )]
